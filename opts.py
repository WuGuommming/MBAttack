...
parser.add_argument('--root_dataset', type=str, default="F:\\workspace\\dataset\\")
...
parser.add_argument('--eval-freq', default=1, type=int, metavar='N',
...
parser.add_argument('--root_model', type=str, default='..\\TDN-mb-checkpoint')
...
parser.add_argument('--attack_type', type=str, default='34')
...
parser.add_argument('--frame_times', type=int, default=10)
